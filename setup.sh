...
if [ -z "$IS_QUEUE_MODE" ]; then
    ...
    $YQ_CMD eval -i '.services."'$N8N_MAIN_SERVICE_NAME'".environment += ["EXECUTIONS_MODE=queue", "QUEUE_BULL_REDIS_HOST='$REDIS_HOST'", "OFFLOAD_MANUAL_EXECUTIONS_TO_WORKERS=true", "N8N_ENFORCE_SETTINGS_FILE_PERMISSIONS=true"]' "$N8N_COMPOSE_PATH"
