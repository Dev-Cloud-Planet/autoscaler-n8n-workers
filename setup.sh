...
if __name__ == "__main__":
    ...
    QUEUE_KEY = "bull:n8n-executions:wait"; QUEUE_THRESHOLD = int(os.getenv('QUEUE_THRESHOLD', 15)); MAX_WORKERS = int(os.getenv('MAX_WORKERS', 5)); MIN_WORKERS = int(os.getenv('MIN_WORKERS', 0))
